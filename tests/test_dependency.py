"""
Test the various dependencies that can be calculated in the RoughOperations such as partial
dependency.
"""
...
class TestDependenciesInRoughOperations(unittest.TestCase):
    """
    ...
    def test_depends_on(self) -> None:
        ...
        knowledge_base.set_granules(self.universe, tags="element")
        ...
        assert knowledge_base.find_relative_positive_region({"P"}, {"Q"}) == frozenset(
            self.universe
        )
